...
<html lang="en">
  ...
  <body>
    <!-- Sidebar -->
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <?php echo anchor('selection', 'UMKM APP', ['class' => 'navbar-brand']); ?>
        </div>
    ...
    echo 'class="active"';
} ?>><?php echo anchor('dashboard', '<i class="fa fa-dashboard"></i> Beranda'); ?></li>
            <li <?php if ($active_page == 'umkm/manage') {
    echo 'class="active"';
} ?>><?php echo anchor('UMKM/manage', '<i class="fa fa-bar-chart-o"></i> UMKM'); ?></li>
